        ...
        <div className="w-full max-w-6xl min-h-[650px] glass-panel bg-white/45 dark:bg-gray-900/45 border border-bit-lavender/30 dark:border-bit-lavender/50 rounded-[2rem] grid lg:grid-cols-12 overflow-hidden relative shadow-xl shadow-bit-lavender/5">
          ...
          <div className="lg:col-span-7 p-6 md:p-10 lg:p-12 flex flex-col relative bg-white/40">
            ...
            <div className="flex-grow bg-white rounded-xl p-4">
              <iframe 
                data-tally-src="https://tally.so/embed/pbQgXP?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1" 
                loading="lazy" 
                width="100%" 
                height="1950" 
                frameBorder="0" 
                marginHeight={0} 
                marginWidth={0} 
                title="Bit by Bit Coding Term 3 — Register"
                className="w-full"
                ></iframe>
            </div>
            ...
            <div className="relative z-10 mt-8">
              <div className="bg-white/10 border border-white/30 rounded-2xl p-6 backdrop-blur-md">
                ...
                <p className="text-sm text-white/90 leading-relaxed">
                  ...
                  <span className="text-white font-bold border-b border-white/50">November 21st</span>. 
